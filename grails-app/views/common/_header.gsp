...
<nav role="navigation">
  ...
  <ul id="menu"> 
    <li tabindex="0"><h2><a href="${createLink(uri: '/')}"><g:message code="default.inicio.label" default="Inicio"/></a></h2></li>
    ...
    <li tabindex="0"><h2><g:link action="list" controller="usuario"><g:message code="default.usuario.label" default="Usuario"/></g:link></h2>
      <ul class="submenu" tabindex="0"> 
        <li tabindex="0"><g:link action="create" controller="usuario"><g:message code="default.usuario.new" default="Agregar Usuario"/></g:link></li>
      </ul>
    </li> 
  </ul>
